...
/* =======================
 * EXPORTACIONES CORTAS Y ESTANDARIZADAS
 * ======================= */

// Altas/Bajas y Activos se exportan directamente con sus nombres originales

// 🎯 Exportaciones cortas para los reportes de Planes (compatibilidad con JSX)
export const getRatingMensual = getPlanesRatingPromedioMensual;
export const getRatingDistribucion = getPlanesRatingDistribucion;